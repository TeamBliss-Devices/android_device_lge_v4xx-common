...
BOARD_KERNEL_CMDLINE := console=none user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=e7 androidboot.selinux=permissive androidboot.bootdevice=msm_sdcc.1
